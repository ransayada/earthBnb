<template>
  <div v-if="isLoading" class="home">
    ...
    <section class="gallery rs-gallery-header">
      <a
        class="gallery-link rs-gallery"
        :href="`#/explore?place=tel-aviv&from=undefined&to=undefined&nog=undefined`"
      >
        <img
          class="gallery-image-ran"
          src="https://res.cloudinary.com/sprint4rad/image/upload/v1638788260/pop-destination/ta2_lapkv3.jpg"
          alt="Tel Aviv"
        />
      ...
      <a
        class="gallery-link rs-gallery"
        :href="`#/explore?place=new-york&from=undefined&to=undefined&nog=undefined`"
      >
        <img
          class="gallery-image-ran"
          src="https://res.cloudinary.com/sprint4rad/image/upload/v1638788261/pop-destination/ny3_laxvb5.jpg"
          alt="New York"
        />
      ...
      <a
        class="gallery-link rs-gallery"
        :href="`#/explore?place=paris&from=undefined&to=undefined&nog=undefined`"
      >
        <img
          class="gallery-image-ran"
          src="https://res.cloudinary.com/sprint4rad/image/upload/v1638788259/pop-destination/pari1_ncwnwg.jpg"
          alt="Paris"
        />
      ...
      <a
        class="gallery-link rs-gallery"
        :href="`#/explore?place=london&from=undefined&to=undefined&nog=undefined`"
      >
        <img
          class="gallery-image-ran"
          src="https://res.cloudinary.com/sprint4rad/image/upload/v1638788262/pop-destination/lon3_awg8bc.jpg"
          alt="London"
        />
    ...
    <section class="gallery" v-if="topStay1">
    ...
    <section class="gallery" v-if="nerby1">
